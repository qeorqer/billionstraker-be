...
userRouter.patch('/setFirstEnter', authMiddleware, userController.setFirstEnter)

userRouter.patch('/setInitialValues', authMiddleware, userController.setInitialValues)
